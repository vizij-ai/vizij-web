  ...
  return (
    <div style={{ display: "grid", gap: 6, color: "#e2e8f0" }}>
      ...
      <div style={{ fontSize: 11, color: "#94a3b8" }}>
        ...
        the runtime (and mirrored frames when `mirrorWrites` is enabled).
      </div>
    </div>
  );
}
    ...
    <aside style={{ padding: 12, width: 360 }}>
      ...
      <section style={{ marginBottom: 12 }}>
        ...
        {String(node.type ?? "")
          ...
          >
            Runtime defaults and staged values will mirror into runtime frames
            only when the controller enables <code>subs.mirrorWrites</code>.
            Keep this in mind when wiring graphs into shared blackboards.
          </div>
        ) : null}
      </section>
