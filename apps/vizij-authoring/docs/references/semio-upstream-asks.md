...
| [STUDIO-124](https://linear.app/semio-ai/issue/STUDIO-124) | No standalone `Slider`; no virtualization in list/tree primitives         | `ui/Slider.tsx` + `ui/RowSlider.tsx` on radix; tree built from à-la-carte primitives.                                                                                                    |
