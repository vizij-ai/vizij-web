...
This demo focuses on visualising Vizij assets without a rig or orchestrator. It provides a
...
```bash
pnpm --filter demo-vizij-render dev      # Start Vite in development mode
pnpm --filter demo-vizij-render build    # Build the demo for production
pnpm --filter demo-vizij-render preview  # Preview the production build
pnpm --filter demo-vizij-render typecheck
```
