                        ...
                        >
                            ...
                            >
                                <header className="flex justify-between items-center px-6 py-4 bg-slate-800/20 border-b border-slate-700/50">
                                    <HeadlessDialog.Title as="h2" className="m-0 text-lg font-bold text-slate-100 uppercase tracking-widest font-heading">
                                        {title}
                                    </HeadlessDialog.Title>
                                    <Button variant="ghost" size="icon" className="w-8 h-8 opacity-70 hover:opacity-100" onClick={onClose} aria-label="Close">
                                        <X className="w-5 h-5" />
                                    </Button>
                                </header>
