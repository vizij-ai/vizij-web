...
export function TimelineEditor() {
    ...
    return (
        ...
        >
            ...
            >
                {tracks.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full text-slate-600 gap-2">
                        ...
                        <span className="text-[10px] italic">Add a variable to start animating</span>
                    </div>
                ) : (
                    tracks.map(track => (
            ...
            <div
                className="absolute top-7 bottom-0 left-48 right-0 pointer-events-none z-20 overflow-hidden"
            >
                <div
