...
- Runtime namespaces are generated per surface from `src/lib/faceAssets.ts` and currently look like `vizij-showcase-<section>`. Keep those names stable enough that runtime debug wiring stays aligned.
