...
function Editor({
  ...
  // These are constants today but kept as state for potential future toggles.
  ...
  return (
    <>
      <MinimalDemoSection
        ...
        description="Load a JSON orchestration, adjust it inline, and push updates into the provider."
      >
        <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
          ...
          <button type="button" onClick={handleStep} style={buttonStyle}>
            Step (1/60s)
          </button>
          <label
            style={{
          ...
          <button type="button" onClick={handleLoadExample} style={buttonStyle}>
            Load example
          </button>
          <label
            style={{
      ...
      <MinimalDemoSection
        ...
        description="Inspect provider writes, conflict resolution, and emitted events."
      >
        <div
          style={{
            display: "grid",
        ...
        >
          <div>
            <h3 style={{ margin: "0 0 0.5rem" }}>Merged writes</h3>
            <pre
              style={{
                margin: 0,
                background: minimalDemoTheme.code,
          ...
          <div>
            <h3 style={{ margin: "0 0 0.5rem" }}>Conflicts</h3>
          ...
          <div>
            <h3 style={{ margin: "0 0 0.5rem" }}>Frame events</h3>
            <pre
              style={{
                margin: 0,
                background: minimalDemoTheme.code,
...
export default function App() {
  ...
  if (!baselineDoc) {
    return (
      <MinimalDemoChrome
        title="Orchestrator playground"
        subtitle="Minimal Vizij sample"
        description="Load sample bundles, tweak the orchestration JSON, and stream updates into the provider."
      >
  ...
  return (
    <OrchestratorProvider autostart={false}>
      <MinimalDemoChrome
        title="Orchestrator playground"
        subtitle="Minimal Vizij sample"
        description="Apply orchestration JSON into @vizij/orchestrator-react and inspect merged writes + events."
      >
        <Editor
