...
```bash
pnpm install
pnpm --filter minimal-demo-orchestrator dev
```
...
```bash
pnpm --filter minimal-demo-orchestrator dev       # start Vite dev server
pnpm --filter minimal-demo-orchestrator build     # production build + type check
pnpm --filter minimal-demo-orchestrator preview   # preview the production build
pnpm --filter minimal-demo-orchestrator typecheck # run tsc --noEmit
```
